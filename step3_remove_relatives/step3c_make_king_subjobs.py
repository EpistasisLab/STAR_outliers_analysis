...
for job in within_subjobs:
    ...
    file.write('#BSUB -R "rusage[mem=31000MB]"\n')
    file.write("#BSUB -M 31000MB\n")
    file.write("#BSUB -n 5\n")
    file.write("module load KING/2.2.4\n\n")

    file.write("king -b data_subset_content/kinship_UKB_samples_filtered_subset" + job)
...
for subset1, subset2 in between_subjobs:
    ...
    file.write("king -b data_subset_content/kinship_UKB_samples_filtered_subset" + subset1 + ".bed,")
    file.write("data_subset_content/kinship_UKB_samples_filtered_subset" + subset2 + ".bed")
    file.write(" --kinship --degree 3 --proj 39197 --cpus 5 --prefix kinship_between" + subset1 + subset2)