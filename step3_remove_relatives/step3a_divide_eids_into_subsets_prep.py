...
eids_fam = pd.read_csv("kinship_UKB_samples_filtered.fam", delim_whitespace = True, usecols = [0, 1], header = None).to_numpy()
...
if len(eids_fam) != 10*len(output_set1):
    print("Error: the sample size needs to be divisible by 10!")
    exit()
